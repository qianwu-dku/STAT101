...
\noindent  \hspace{-4mm}  \begin{tabular}{ l l }
  ...
  \textbf{Class Dates:}			& 01/05/2026 – 02/26/2026 \\
  \textbf{Lecture Time:}			& \large MoWe 8:30AM - 11:00AM\\
  \textbf{Lecture Location:} 		& \large IB 2071\\
    \textbf{Office Hours:} & \large TuTh 12:00PM -- 2:00PM and by appointment\\
     & \\
...
\textbf{E-mail: }          & \large{\href{mailto:jingyu.wang@dukekunshan.edu.cn}{jingyu.wang@dukekunshan.edu.cn}} \\
 \textbf{Lab Time:}              & \large Th 10:00AM - 11:15AM\\
 \textbf{Lab Location:}          & \large IB 2071\\
 \textbf{Office Hours:} & \large Fr 10:00AM -- 12:00PM in WDR 3016\\
...
A third set of goals for the course is that you will also be able to read more fluently research literature that employs statistics. At the end of the course, we will use actual academic article(s) to learn how to read and interpret empirical research. Doing so should help you understand how data is used (and misused) to construct social science arguments.
...
\begin{itemize}
    ...
    \item Apply statistical methods to future social science coursework, capstone project, and signature work.
...
\begin{itemize}
    ...
    \item Interpret statistical results to understand both significance the of the results and their substantive impact.
    \item Illustrate statistical results with appropriate and clear graphical displays that provide meaning to the reader.
    \item Evaluate statistical work with the skills and techniques learned in class.
    \item Propose an independent research project that integrates statistical methods with research interests.
\end{itemize}
...
\begin{itemize}
    ...
    \item Thursday: Lab activities designed to help gain familiarity with the technical aspects of using R, and RStudio.
...
\begin{itemize}
    \item Class Canvas Websites: \href{https://canvas.duke.edu/courses/76261}{https://canvas.duke.edu/courses/76261}. I will use Canvas for posting assignments, class announcements, grades, and other materials, so please make sure to read these messages carefully and check Canvas regularly.
...
\begin{itemize}
    ...
    \end{itemize}
    \item Unit 3 exam (20\%): Unit 3 comprehension is better checked through an in-class exam. The exam will be open notes but closed book\footnote{The exam is paper-and-pencil-based. You must print out any digital notes, there is no page limit. Calculators are allowed.} and will take place during the normal lab session that week.
...
\Large \textcolor{blue}{\textit{\textbf{Unit 1: Distributions}}} \\

\large \textbf{Week 1}
\begin{itemize}
    \item Lecture 1.1: Intro to the course (Monday, Jan 5)
    \begin{itemize}
        ...
        \end{itemize}
    \end{itemize}
    \item Lecture 1.2: Characteristics of distributions (Wednesday, Jan 7)
    \begin{itemize}
        ...
        \end{itemize}
    \end{itemize}
    \item Lab 1: R and Quarto familiarization (Thursday, Jan 8)
    \item To-dos: 
    \begin{itemize}
        \item DataCamp lab 1: Introduction to R and Tidyverse (due Friday, Jan 9 at 11:59 pm)
    \end{itemize}
\end{itemize}
...
\textbf{Week 2}
\begin{itemize}
    \item Lecture 2.1: Normal distribution (Monday, Jan 12)
    \begin{itemize}
...
\newpage
\Large \textcolor{blue}{\textit{\textbf{Unit 2: Relationships between variables}}} \\

\large \textbf{Week 2}
\begin{itemize}
    \item Lecture 2.2: Association and correlation (Wednesday, Jan 14)
    \begin{itemize}
        ...
        \end{itemize}
    \end{itemize}
    \item Lab 2: Advanced Quarto editing (Thursday, Jan 15)
    \item To-dos:
    \begin{itemize}
        \item DataCamp lab 2: Introduction to Data Visualization with ggplot2 (due Friday, Jan 16 at 11:59 pm)
        \item Homework assignment 1 (due Sunday, Jan 18 at 11:59 pm)
    \end{itemize}
\end{itemize}
...
\textbf{Week 3}
\begin{itemize}
    \item Lecture 3.1: Simple linear regression (Monday, Jan 19)
    \begin{itemize}
        ...
        \end{itemize}
    \end{itemize}
    \item Lecture 3.2: Regression wisdom (Wednesday, Jan 21)
    \begin{itemize}
        ...
        \end{itemize}
    \end{itemize}
    \item Lab 3: Working with regressions using dplyr (Thursday, Jan 22)
    \item To-dos:
    \begin{itemize}
        \item DataCamp lab 3: Intermediate Data Visualization with ggplot2 (due Friday, Jan 23 at 11:59 pm)
    \end{itemize}
\end{itemize}
...
\textbf{Week 4}
\begin{itemize}
    \item Lecture 4.1: Multiple regression (Monday, Jan 26)
    \begin{itemize}
        ...
        \end{itemize}
    \end{itemize}
    \item Lecture 4.2: Confidence intervals for proportions (Wednesday, Jan 28)
    \begin{itemize}
        \item Reading: Chapter 13
        \item Topics:
        \begin{itemize}
            \item Sampling distribution for proportions
            \item Assumptions and Conditions
            \item Construct confidence interval
            \item Interpret confidence interval
        \end{itemize}
    \end{itemize}
    \item Lab 4: Interpreting regression coefficients (Thursday, Jan 29)
    \item To-dos:
    \begin{itemize}
        \item DataCamp lab 4: Modeling with Data in the Tidyverse (due Friday, Jan 30 at 11:59 pm)
        \item Homework assignment 2 (due Sunday, Feb 1 at 11:59 pm)
    \end{itemize}
\end{itemize}
...
\Large \textcolor{blue}{\textit{\textbf{Unit 3: Measuring uncertainty}}} \\

\large \textbf{Week 5}
\begin{itemize}
    \item Lecture 5.1: Confidence interval for means (Monday, Feb 2)
    \begin{itemize}
        ...
        \end{itemize}
    \end{itemize}
    \item Lecture 5.2: Hypothesis testing (Wednesday, Feb 4)
    \begin{itemize}
        ...
        \begin{itemize}
            ...
            \item Two-tail tests
            \item Hypothesis test for population means
            \item Hypothesis test for population proportions
        \end{itemize}
    \end{itemize}
    \item Lab 5: Bootstrapping confidence interval (Thursday, Feb 5)
    \item To-dos:
    \begin{itemize}
        \item DataCamp lab 5: Your choice of any DataCamp course (due Friday, Feb 6 at 11:59 pm)
    \end{itemize}
\end{itemize}

\textbf{Week 6}
\begin{itemize}
    \item Lecture 6.1: Hypothesis testing wisdom (Monday, Feb 9)
    \begin{itemize}
...
\Large \textcolor{blue}{\textit{\textbf{Unit 4: Statistical inference}}} \\

\large \textbf{Week 6}

\begin{itemize}
    \item Lecture 6.2: Comparing groups (Wednesday, Feb 11)
    \begin{itemize}
        \item Reading: Chapter 17
        \item Topics:
        \begin{itemize}
            \item Comparing proportions across two samples
            \item Comparing means across two samples
        \end{itemize}
    \end{itemize}
    \item Lab 6: Unit 3 exam (Thursday, Feb 12)
\end{itemize}


\textbf{Week 7}
\begin{itemize}
    \item Lecture 7.1: Returning to regression (Friday, Feb 13)
    \begin{itemize}
        \item Reading: Chapter 20
        \item Topics:
        \begin{itemize}
            \item Hypothesis test for coefficients
            \item Assumptions and conditions
            \item Confidence and prediction intervals
        \end{itemize}
    \end{itemize}
    \item Lecture 7.2: Interpretation activity \& model building practice (Wednesday, Feb 25)
    \begin{itemize}
        \item Topics:
        \begin{itemize}
        ...
        \end{itemize}
    \end{itemize}
    \item Lab 7: Independent learning for individual final project (Thursday, Feb 26)
    \item To-dos: 
    \begin{itemize}
        \item Individual final project (due Monday, Mar 2 at 11:59 pm)
    \end{itemize}
\end{itemize}
\end{document}
